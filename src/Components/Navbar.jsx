...
const Navbar = () => {
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg fixed-top mb-5 navbar-dark bg-dark">
  <div className="container">
    <Link className="navbar-brand text-light" to="/"><span className='shop fw-bold'>ApniDakan</span>.com</Link>
